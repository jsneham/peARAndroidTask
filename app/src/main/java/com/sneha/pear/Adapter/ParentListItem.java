...
public interface ParentListItem {
     ...
     *
     * @return A {@link List} of the children of this {@link com.technocodellp.palgharkar.Models.ParentListItem}
     */
    List<?> getChildItemList();

    /**
     * Getter used to determine if this {@link com.technocodellp.palgharkar.Models.ParentListItem}'s
